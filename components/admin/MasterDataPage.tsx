  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        {/* Ribbon Header */}
        <div className="bg-indigo-600 dark:bg-indigo-800 px-8 py-5 flex items-center justify-between text-white">
        ...
        <div className="p-8">
          <div className="flex flex-wrap gap-4 items-center mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={onAddNew}
                className="flex items-center gap-2 px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl text-sm font-extrabold shadow-lg hover:shadow-xl transition transform hover:scale-105">
                ...
                <tr className="bg-slate-50/20 dark:bg-slate-900/20 border-b border-slate-100 dark:border-slate-700">
                  ...
                  <th className="px-6 py-2">
                    <input
                      ...
                      placeholder={
                        isUserEntity ? "Filter Email" : "Filter Code"
                      }
                      className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md px-2 py-1 text-[10px] outline-none"
                    />
                  </th>
